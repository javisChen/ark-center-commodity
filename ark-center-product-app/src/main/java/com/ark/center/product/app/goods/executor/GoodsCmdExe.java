...
import com.ark.center.product.domain.spu.*;
import com.ark.center.product.domain.spu.assembler.SkuAssembler;
...
import com.ark.center.product.infra.product.gateway.cache.CommodityCacheConst;
...
public class GoodsCmdExe {
    ...
    private void saveSku(GoodsCmd cmd, Spu spu) {
        ...
        for (SkuCmd skuCmd : skuList) {
            ...
            saveSkuAttrs(sku.getId(), skuCmd.getSpecs());
    ...
    private void saveAttrOptions(GoodsCmd cmd, Spu spu) {
