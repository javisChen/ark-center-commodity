package com.kt.cloud.commodity.module.sku.dto.request;
 ...
 */
@Data
@ApiModel(value = "SkuCreateReqDTO对象", description = "sku")
public class SkuCreateReqDTO implements Serializable {
